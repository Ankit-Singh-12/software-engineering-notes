...
direct constructor call (new operator). Subclasses can override this method to change the class 
of objects that will be created.

Usage examples: The Factory Method pattern is widely used in Python code. 
...
objects from concrete classes. While concrete classes are used during the object creation, 
